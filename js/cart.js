...
document.addEventListener("DOMContentLoaded", function () {
  //Realizo un addevenlistener para que me cargue el DOM
...
function peticion(data) {
  //Realizo una funcion con una tabla en las cuales ingreso los datos solicitados
...
function subTotal(total) {
  //Creo una funcion para realziar la multiplicacion, para luego mostrarla en el subtotal
